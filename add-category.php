...
if (strlen($_SESSION['aid'] == 0)) {
    ...
    if (isset($_POST['submit'])) {
        ...
        $query = mysqli_query($con, "insert into tblcategory(userID,CategoryName,CategoryCode) values('$userID','$catname','$catcode')");
        ...
        for ($i = 1; $i <= 100; $i++) {
            if ($GLOBALS['total_sub_category'] == 20) {
                ...
                if (isset($_POST['subcategory' . $i])) {
                    ...
                    $query1 = mysqli_query($con, "insert into tblsubcategory(userID,category_code,sub_category_code,sub_category_name) values('$userID','$catcode','$subcatcode','$subcatname')");
