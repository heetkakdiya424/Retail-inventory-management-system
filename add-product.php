    ...
    if (isset($_POST['submit'])) {
        ...
        if (isset($_POST['edrequired'])) {
            ...
            if (strtotime($expirydate) > $futureDate) {
                $query = mysqli_query($con, "insert into tblproducts(userID,CategoryName,SubCategoryName,CompanyName,ProductName,ProductPrice,ExpiryDate,Stock,ImagePath) values('$userID','$catname','$subcatname','$company','$pname','$pprice','$expirydate','$stock','$newLocation')");
                if ($query) {
...
?>
    ...
    <?php
            ...
            $query = mysqli_query($con, "insert into tblproducts(userID,CategoryName,SubCategoryName,CompanyName,ProductName,ProductPrice,Stock,ImagePath) values('$userID','$catname','$subcatname','$company','$pname','$pprice','$stock','$newLocation')");
            if ($query) {
                echo "<script>alert('Product added successfully.');</script>";
                echo "<script>window.location.href='add-product.php'</script>";
            } else {
                                            ...
                                            <div class="form-row">
                                                <div class="col-md-6 mb-10">
                                                    ...
                                                    <select class="form-control custom-select" name="category" onChange="subcategory(this.value)" required>
                                                        ...
                                                        <?php
                                                        $userID = $_SESSION['aid'];
                                                        $ret = mysqli_query($con, "select CategoryName from tblcategory where userID='$userID'");
                                            ...
                                            <div class="form-row" id="subcategory1">
                                                <div class="col-md-6 mb-10">
                                                    ...
                                                    <select class="form-control custom-select" name="subcategory" required>
                                                        ...
                                                        <?php
                                                        $ret = mysqli_query($con, "select * from tblsubcategory where userID='$userID'");
                                                        while ($row = mysqli_fetch_array($ret)) { ?>
                                            ...
                                            <div class="form-row">
                                                <div class="col-md-6 mb-10">
                                                    ...
                                                    <select class="form-control custom-select" name="company" required>
                                                        ...
                                                        <?php
                                                        $ret = mysqli_query($con, "select CompanyName from tblcompany  where userID='$userID'");
                                                        while ($row = mysqli_fetch_array($ret)) { ?>
