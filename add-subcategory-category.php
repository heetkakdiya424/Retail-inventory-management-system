...
if (strlen($_SESSION['aid'] == 0)) {
    ...
    if (isset($_POST['submit'])) {
        ...
        $query = mysqli_query($con, "insert into tblsubcategory(userID,category_code,sub_category_code,sub_category_name) values('$userID','$catcode','$subcatcode','$subcatname')");
            ...
            <div class="hk-pg-wrapper">
                ...
                <div class="container">
                    ...
                    <div class="hk-pg-header">
                        <h4 class="hk-pg-title"><span class="pg-title-icon"><span class="feather-icon"><i data-feather="external-link"></i></span></span>Add Sub-Category</h4>
                    </div>
                    <!-- /Title -->
                                        ...
                                        <form class="needs-validation" method="post" novalidate>
                                            ...
                                            <div class="form-row">
                                                <div class="col-md-6 mb-10">
                                                    ...
                                                    <select class="form-control custom-select" name="category" required>
                                                        ...
                                                        $query = "SELECT CategoryCode, CategoryName FROM tblcategory WHERE userID='$userID'";
                                            ...
                                            <div class="form-row">
                                                <div class="col-md-6 mb-10">
                                                    ...
                                                    <input type="text" class="form-control" id="validationCustom03" placeholder="Sub Category Name" name="subcategoryname" required>
