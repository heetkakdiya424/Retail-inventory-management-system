                    ...
                    <div class="row">
                        <div class="col-xl-12">
                            <div class="hk-row">
                                ...
                                <?php
                                $userID = $_SESSION['aid'];
                                $query = mysqli_query($con, "select id from tblcategory  where userID='$userID'");
                                ...
                                <?php
                                $subc = mysqli_query($con, "select id from tblsubcategory where userID='$userID'");
                                        ...
                                        <div class="card card-sm">
                                            <div class="card-body">
                                                ...
                                                <div class="text-center">
                                                    ...
                                                    <small class="d-block">Listed Sub-Categories</small>
                                                </div>
                                            </div>
                                        </div>
                                    </a>
                                ...
                                <?php
                                $ret = mysqli_query($con, "select id from tblcompany where userID='$userID'");
                                ...
                                <?php
                                $sql = mysqli_query($con, "select id from tblproducts where userID='$userID'");
                                ...
                                <?php
                                $qurys = mysqli_query($con, "select sum(tblorders.Quantity*tblproducts.ProductPrice) as tt  from tblorders join tblproducts on tblproducts.id=tblorders.ProductId where date(tblorders.InvoiceGenDate)=CURDATE()-1 AND tblorders.userID='$userID'");
                                ...
                                <?php
                                $qury = mysqli_query($con, "select sum(tblorders.Quantity*tblproducts.ProductPrice) as tt  from tblorders join tblproducts on tblproducts.id=tblorders.ProductId where date(tblorders.InvoiceGenDate)>=(DATE(NOW()) - INTERVAL 7 DAY) AND tblorders.userID='$userID'");
                                ...
                                <?php
                                $query = mysqli_query($con, "select sum(tblorders.Quantity*tblproducts.ProductPrice) as tt  from tblorders join tblproducts on tblproducts.id=tblorders.ProductId where tblorders.userID='$userID'");
                            ...
                            <div class="hk-row">
                                ...
                                $exdate = mysqli_query($con, "SELECT ExpiryDate FROM tblproducts WHERE userID='$userID'");
                                if ($exdate) {
                                ...
                                ?>
                                 ...
                                 <?php
                                $stockout = mysqli_query($con, "select Stock from tblproducts where userID='$userID'");
                                $sop = 0;
