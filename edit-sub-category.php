            ...
            <div class="hk-pg-wrapper">
                ...
                <div class="container">
                    ...
                    <div class="hk-pg-header">
                        <h4 class="hk-pg-title"><span class="pg-title-icon"><span class="feather-icon"><i data-feather="external-link"></i></span></span>Edit Sub-Category</h4>
                    </div>
                    <!-- /Title -->
                                ...
                                <div class="row">
                                    <div class="col-sm">
                                        <form class="needs-validation" method="post" novalidate>
                                            <?php
                                            $scid = substr(base64_decode($_GET['scatid']), 0, -5);
                                            $ret = mysqli_query($con, "select * from tblsubcategory where ID='$scid'");
                                            ...
                                            <div class="form-row">
                                                <div class="col-md-6 mb-10">
                                                    ...
                                                    <select class="form-control" name="categoryname">
                                                        <?php
                                                        $uid = $_SESSION['aid'];
                                                        $ctn = mysqli_query($con, "select * from tblcategory where userID='$uid'");
