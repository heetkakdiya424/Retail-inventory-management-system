...
if (strlen($_SESSION['aid'] == 0)) {
    ...
    if (isset($_POST['update'])) {
        ...
        $query = mysqli_query($con, "update tbladmin set ShopOwnerName='$shopownername',ShopName='$shopname' where id='$adminid'");
        if ($query) {
                                            ...
                                            ?>
                                                ...
                                                <div class="form-row">
                                                    <div class="col-md-6 mb-10">
                                                        ...
                                                        <input type="text" class="form-control" id="validationCustom03" value="<?php echo $row['ShopOwnerName']; ?>" name="shopownername" required>
                                                ...
                                                <div class="form-row">
                                                    <div class="col-md-6 mb-10">
                                                        ...
                                                        <input type="text" class="form-control" id="validationCustom03" value="<?php echo $row['ShopName']; ?>" name="shopname" required>
                                                        <div class="invalid-feedback">Please provide a valid name.</div>
                                                    </div>
                                                </div>
