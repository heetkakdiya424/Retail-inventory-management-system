                                            ...
                                            <div class="table-wrap">
                                                <table id="datable_1" class="table table-hover w-100 display pb-30">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        ?>
                                                            <form method="post" action="search-product-test.php?action=add&pid=<?php echo $row["id"]; ?>">
                                                                <tr>
                                                                    <td><?php echo $cnt; ?></td>
                                    ...
                                    <div class="row">
                                        <div class="col-sm">
                                            <div class="table-wrap">
                                                ...
                                                <a id="btnEmpty" href="search-product-test.php?action=empty">Empty Cart</a>
                                                <?php
                                                        ...
                                                        <tbody>
                                                            ...
                                                            ?>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td><a href="search-product-test.php?action=remove&code=<?php echo $item["code"]; ?>" class="btnRemoveAction"><img src="dist/img/remove.png" alt="Remove Item" /></a></td>
                                                                </tr>
                                                            <?php
