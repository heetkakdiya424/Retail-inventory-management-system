    ...
    if ($_POST['cpassword'] != $_POST['password']) {
        ...
        if (preg_match($pattern, $_POST['password'])) {
            if (preg_match($pattern1, $cmobileno)) {
                ...
                $checkUser = mysqli_query($con, "SELECT Email FROM tbladmin WHERE Email = '$email' ");
                if (mysqli_num_rows($checkUser) > 0) {
                    echo "<script>alert('Email already taken.');</script>";
                } else {
                    $query = mysqli_query($con, "INSERT INTO tbladmin(ShopOwnerName, ShopName, UserName, Email, Password, MobileNumber) values(' $shopownername', '$shopname', '$username', '$email', '$password',  '$mobilenumber') ");
                    if ($query) {
        ...
        <div class="hk-pg-wrapper hk-auth-wrapper">
            <header class="d-flex justify-content-between align-items-center">
                <a class="d-flex auth-brand align-items-center" href="#">
                    <span class="text-white font-50">EasyTex</span>
                </a>
                ...
                <div class="row">
                    <div class="col-xl-5 pa-0">
                        <div id="owl_demo_1" class="owl-carousel dots-on-item owl-theme">
                            <div class="fadeOut item auth-cover-img overlay-wrap" style="background-image:url(dist/img/hellcat.jpg);">
                            ...
                            <div class="fadeOut item auth-cover-img overlay-wrap" style="background-image:url(dist/img/Porsche-911.webp);">
                                <div class="auth-cover-info py-xl-0 pt-100 pb-50">
                                    <div class="auth-cover-content text-center w-xxl-75 w-sm-90 w-xs-100">
                    ...
                    <div class="col-xl-7 pa-0">
                        <div class="auth-form-wrap py-xl-0 py-50">
                            <div class="auth-form w-xxl-55 w-xl-75 w-sm-90 w-xs-100">
                                <form method="post">
                                    <h1 class="display-4 mb-10">SingUp</h1>

                                    <!-- Shop Owner Name -->
                                    <div class="form-group">
                                        <input class="form-control" placeholder="Shop Owner Name" type="text" name="shopownername" required="true" \>
                                    </div>

                                    <!-- Shop Name -->
                                    <div class="form-group">
                                        <input class="form-control" placeholder="Shop Name" type="text" name="shopname" required="true">
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <div class="input-group">
                                            <input class="form-control" placeholder="Conform Password" type="password" name="cpassword" required="true">
                                            <div class="input-group-append">
                                                <span class="input-group-text"><span class="feather-icon"><i data-feather="eye-on"></i></span></span>
                                            </div>
                                        </div>
                                    ...
                                    <!-- Mobile Number -->
                                    <div class="form-group">
                                        <input class="form-control" placeholder="Mobile Number" type="number" name="mobilenumber" required="true">
                                    </div>
