            ...
            <div class="hk-pg-wrapper">
                ...
                <div class="container">
                    ...
                    <div class="hk-pg-header">
                        <h4 class="hk-pg-title"><span class="pg-title-icon"><span class="feather-icon"><i data-feather="database"></i></span></span>StockOut Products</h4>
                    </div>
                    <!-- /Title -->
                                        ...
                                        <div class="table-wrap">
                                            <table id="datable_1" class="table table-hover w-100 display pb-30">
                                                ...
                                                <tbody>
                                                    ...
                                                    $stockout = mysqli_query($con, "select * from tblproducts where userID='$userID'");
                                                    if ($stockout) {
